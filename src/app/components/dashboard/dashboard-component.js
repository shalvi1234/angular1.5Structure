...
dashboardController.$inject = ['$http', 'auth', 'Session', '$location', '$rootScope', '$state', 'configService'];

function dashboardController($http, auth, Session, $location, $rootScope, $state, configService) {
    var self = this;
